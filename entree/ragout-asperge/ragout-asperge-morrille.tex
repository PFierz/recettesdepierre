...
{Ragoût d'asperges et morilles}
    ...
    \suggestion[Variantes] {
      \begin{itemize}
       \item Si l'on ne trouve pas de morilles fraîches prendre \unit[20]{gr} de morilles séchées.
       \item Si l'on n'a pas de vin jaune on peut utiliser du Xeres sec. Ce sera aussi moins cher.
      \end{itemize}
    }
    
    \hint {% Tipp
	 Les asperges sont fraîches, si elle grince lorsqu'on les frotte les une aux autres.
    }
